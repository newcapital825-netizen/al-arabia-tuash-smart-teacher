...
|---|---|---|---:|---|---|---|
| PDF-TEXT-001 | PDF عربي نصي | /home/ubuntu/upload/ستةمراجعةنهائية-.طلاب.pdf | 26 | PDF extraction ×2; 459 code units; 0 Arabic codepoints; 0 embedded fonts | لا | TESTED — FAIL / TEXT LAYER NOT USABLE |
...
| DOCX-001 | DOCX عربي | /home/ubuntu/upload/برنامج-المهارات.docx | 1 logical document | Mammoth extraction ×2; 2,233 Arabic codepoints; 31 punctuation marks | لا | TESTED — PASS / STABLE |
| DOCX-AR-001 | DOCX عربي إضافي | غير متاح محليًا | — | — | لا | BLOCKED — REAL SAMPLE REQUIRED |
...
| PDF-TEXT-001-MISSING | PDF عربي نصي مستقل إضافي | غير متاح محليًا | — | — | لا | BLOCKED — REAL SAMPLE REQUIRED |
